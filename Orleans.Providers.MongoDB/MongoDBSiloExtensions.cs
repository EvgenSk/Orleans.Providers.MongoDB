...
namespace Orleans.Hosting
{
    ...
    public static class MongoDBSiloExtensions
    {
            ...
            Action<OptionsBuilder<MongoDBGrainStorageOptions>> configureOptions = null)
        {
            ...
            services.AddTransient<IConfigurationValidator>(sp => new MongoDBGrainStorageOptionsValidator(sp.GetService<IOptionsMonitor<MongoDBGrainStorageOptions>>().Get(name), name));
